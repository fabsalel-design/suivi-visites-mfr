...
const Y_GESTION_TEMPS = 450;
const Y_PRODUCTIVITE = 405;
const Y_RESPONSABILITES = 360;
const Y_JUGEMENT = 395;
const Y_COMMUNICATION = 270;
const Y_RELATIONS = 225;
const Y_ADAPTATION = 180;
const Y_TRAVAIL_BIEN_FAIT = 135;
